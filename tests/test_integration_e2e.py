...
class TestEndToEndIntegration:
    ...
    def integration_daemon(self, mock_device, mock_audio_backend):
        ...
        led_controller = LEDFeedbackController(
            device=mock_device,
    ...
    @pytest.mark.asyncio
    async def test_complete_button_press_workflow(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    @pytest.mark.asyncio
    async def test_multiple_toggle_cycles(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    @pytest.mark.asyncio
    async def test_device_disconnection_handling(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    @pytest.mark.asyncio
    async def test_audio_backend_error_handling(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    @pytest.mark.asyncio
    async def test_led_feedback_synchronization(self, integration_daemon, mock_device, mock_audio_backend):
        ...
        expected_colors = [LEDColor.GREEN, LEDColor.RED, LEDColor.GREEN, LEDColor.RED, LEDColor.GREEN]
        ...
        for i, (muted_state, expected_color) in enumerate(zip(states, expected_colors)):
            ...
            assert mock_device.get_led_color() == expected_color, f"Cycle {i}: expected {expected_color}, got {mock_device.get_led_color()}"
        
        await integration_daemon.stop()
        await daemon_task

    @pytest.mark.asyncio
    async def test_concurrent_events_handling(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    @pytest.mark.asyncio
    async def test_system_recovery_after_errors(self, integration_daemon, mock_device, mock_audio_backend):
    ...
    async def test_configuration_integration(self):
        ...
        with patch('muteme_btn.core.daemon.MuteMeDevice') as mock_device_class, \
