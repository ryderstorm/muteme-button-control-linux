...
from muteme_btn.audio.pulse import PulseAudioBackend, AudioConfig
from muteme_btn.config import DeviceConfig
from muteme_btn.core.state import ButtonStateMachine, ButtonEvent
...
class MuteMeDaemon:
    ...
    def __init__(
        ...
        device: Optional[MuteMeDevice] = None,
        audio_backend: Optional[PulseAudioBackend] = None,
        state_machine: Optional[ButtonStateMachine] = None,
        led_controller: Optional[LEDFeedbackController] = None
    ):
